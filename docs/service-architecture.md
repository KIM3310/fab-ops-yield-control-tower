# Service Architecture - fab-ops-yield-control-tower
...
- **Lane:** Manufacturing operations control tower
- **Primary buyer:** Manufacturing and semiconductor operations teams
- **First motion:** Synthetic data control-tower review and operator workflow mapping

## Recommended Architecture

Static/UI host, FastAPI/container backend, Postgres for events and shift handoff, object storage for reports, queue for batch analytics.
...
- synthetic data until NDA and scope
- human operator review
- downtime/yield claims backed by buyer data only
