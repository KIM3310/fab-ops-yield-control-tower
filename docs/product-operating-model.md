...
| Area | Position |
| --- | --- |
| Target reviewer | Manufacturing operations and semiconductor support teams |
| Service wedge | Factory operations control tower prototype |
| Review signal | Yield monitoring, shift handoff, qualification analytics |
