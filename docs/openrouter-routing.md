...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.4-mini` | Fab shift reports, recovery summaries, and connector-readiness explanations. |
...
OPENROUTER_HTTP_REFERER=https://fab-ops-yield-control-tower.pages.dev
OPENROUTER_APP_TITLE=fab-ops-yield-control-tower
```
