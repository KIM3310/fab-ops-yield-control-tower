# Service Growth Model - fab-ops-yield-control-tower
...
| Field | Decision |
|---|---|
| Service type | Manufacturing operations control tower |
| Primary reader or buyer | Manufacturing and semiconductor operations teams. |
| Wedge | Synthetic data control-tower review and operator workflow mapping. |
